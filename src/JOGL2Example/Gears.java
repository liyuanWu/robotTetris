...
public class Gears implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        System.err.println("JOGL2Example.Gears: Init: "+drawable);
        // Use debug pipeline
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        System.err.println("JOGL2Example.Gears: Reshape "+x+"/"+y+" "+width+"x"+height);
        GL2 gl = drawable.getGL().getGL2();
    ...
    public void dispose(GLAutoDrawable drawable) {
        System.err.println("JOGL2Example.Gears: Dispose");
        setGears(0, 0, 0);
    }
    ...
    class
            GearsMouseAdapter extends MouseAdapter {
        @Override
